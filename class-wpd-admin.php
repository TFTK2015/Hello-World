                                    ...
                                    <li>
                                        <a href="#">
                                            ...
                                            <span>
                                                ...
                                                One of our products arouses your interest but itâ€™s not exactly what you want. If only some features can be addedâ€¦ You know what? Actually itâ€™s possible! Just leave your suggestion and weâ€™ll do our best! 
                                            </span>
                                        </a>
                                    </li>
...
//        $upload_icon = array(
//            'type' => 'image',
//            'title' => __('Tab icon', 'wpd'),
//            'name' => "wpc-upload-options[upload]",
//            'set' => 'Set',
//            'remove' => 'Remove'
//        );
//        $upload_group = array(
...
//            'type' => 'groupedfields',
//            'fields' => array($upload_icon));

//        array_push($options, $actions_options_begin);
//        array_push($options, $upload_group);
//        array_push($options, $actions_options_end);



////uploads color
//        $colors_array_uploads = array(
//            'label-color' => __('Text color<br/>'),
//            'normal-color' => __('Background color<br/>'),
//            'selected-color' => __('Background color on hover<br/>')
//        );
//
//        foreach ($colors_array_uploads as $key => $label_color) {
//            $css = "background-color:" . $color_labels[$key];
//            $uploads_options_array[] = array($label_color, 'wpc-upload-options', $key, 'text', $color_labels[$key], 'wpc-color', $css, '', '');
//        }
//
//        foreach ($uploads_options_array as $option_array) {
//
//            $uploads_fields[] = $this->get_admin_option_field($option_array[0], $option_array[1], $option_array[2], $option_array[3], $option_array[4], $option_array[5], $option_array[6], $option_array[7], $option_array[8]);
//        }
//        $i = 0;
//        $grill_data = array();
//        foreach ($uploads_fields as $fields) {
//
//            $i = $i + 1;
//            array_push($grill_data, $fields);
//            if ($i == 3) {
//                $grill = array(
//                    'title' => 'Uploads Title section',
//                    'type' => 'groupedfields',
//                    'fields' => array($grill_data[$i - 3], $grill_data[$i - 2], $grill_data[$i - 1]));
//                array_push($options, $actions_options_begin);
//                array_push($options, $grill);
//                array_push($options, $actions_options_end);
//            }
//        }
//
...
//        $facebook_icon = array(
//            'type' => 'image',
//            'title' => __('Facebook Tab icon', 'wpd'),
//            'name' => "wpc_social_networks[facebook]",
//            'set' => 'Set',
//            'remove' => 'Remove'
//        );
//        $instagram_icon = array(
//            'type' => 'image',
//            'title' => __('Instagram Tab icon', 'wpd'),
//            'name' => "wpc_social_networks[instagram]",
//            'set' => 'Set',
//            'remove' => 'Remove'
//        );
//        $grill = array(
//            'title' => __('Social network', 'wpd'),
//            'type' => 'groupedfields',
//            'fields' => array($facebook_icon, $instagram_icon));
...
//        $colors_array = array(
//            'facebook' => array(
//                'label-color' => __('Text color'),
//                'normal-color' => __('Background color'),
//                'selected-color' => __('Background color on hover')),
//            'instagram' => array(
//                'label-color' => __('Instagram section title text color'),
//                'normal-color' => __('Instagram section title background color'),
//                'selected-color' => __('Instagram title section background color on hover')),
//        );
//        foreach ($colors_array as $social => $colors) {
//            $socials_options = $this->get_admin_color_field($social_networks_options, $social);
//            foreach ($colors as $key => $label_color) {
//                $css = "background-color:" . $socials_options[$key];
//                $social_name = $social . '-' . $key;
//                $networks_array[] = array($label_color, 'wpc_social_networks', $social_name, 'text', $socials_options[$key], 'wpc-color', $css, '', '');
//            }
//        }
//        foreach ($networks_array as $option_array) {
//            $networks_fields[] = $this->get_admin_option_field($option_array[0], $option_array[1], $option_array[2], $option_array[3], $option_array[4], $option_array[5], $option_array[6], $option_array[7], $option_array[8]);
//        }
//        $i = 0;
//        $grill_data = array();
//        foreach ($networks_fields as $fields) {
//            $i = $i + 1;
//            array_push($grill_data, $fields);
//            switch ($i) {
//                case 3:
//                    $label = __('Facebook section title');
//                    $grill = array(
//                        'title' => $label,
//                        'type' => 'groupedfields',
//                        'fields' => array($grill_data[$i - 3], $grill_data[$i - 2], $grill_data[$i - 1]));
...
//
//                case 6:
//                    $label = __('Instagram section title');
//                    $grill = array(
//                        'title' => $label,
//                        'type' => 'groupedfields',
//                        'fields' => array($grill_data[$i - 3], $grill_data[$i - 2], $grill_data[$i - 1]));
...
//
//        $related_products_options = $wpc_options_settings['wpc-related-products'];
//
//        $default_color = get_proper_value($related_products_options, 'label-color', "");
//        $bg_default_color = get_proper_value($related_products_options, 'normal-color', "");
//        $hover_default_color = get_proper_value($related_products_options, 'selected-color', "");
//
//
//        $related_products_options_begin = array(
//            'type' => 'sectionbegin',
//            'title' => __('Related Products Settings', 'wpd'),
//            'id' => 'wpc-related-products-options',
//            'table' => 'options'
//        );
//        $related_products_options_end = array('type' => 'sectionend');
//
////Related products part icon
//        $related_products_icon = array(
//            'type' => 'image',
//            'title' => __('Tab Pick Product icon', 'wpd'),
//            'name' => "wpc-related-products[related-product]",
//            'set' => 'Set',
//            'remove' => 'Remove'
//        );
//        array_push($options, $related_products_options_begin);
//        $grill = array(
//            'title' => 'Related products',
//            'type' => 'groupedfields',
//            'fields' => array($related_products_icon));
//        array_push($options, $grill);
//        array_push($options, $related_products_options_end);
//
////Related products part color
//
//        $related_products_label_color = array(
//            'type' => 'text',
//            'title' => __('Product color', 'wpd'),
//            'name' => "wpc-related-products[label-color]",
//            'class' => 'wpc-color',
//            'default' => $default_color
//        );
//        $related_products_bg_color = array(
//            'type' => 'text',
//            'title' => __('Background color', 'wpd'),
//            'name' => "wpc-related-products[normal-color]",
//            'class' => 'wpc-color',
//            'default' => $bg_default_color
//        );
//
//        $related_products_hover_bg_color = array(
//            'type' => 'text',
//            'title' => __('Background color', 'wpd'),
//            'name' => "wpc-related-products[selected-color]",
//            'class' => 'wpc-color',
//            'default' => $hover_default_color
//        );
//
//        $grill = array(
//            'title' => 'Title section pick',
//            'type' => 'groupedfields',
//            'fields' => array($related_products_label_color, $related_products_bg_color, $related_products_hover_bg_color));
//        array_push($options, $related_products_options_begin);
//        array_push($options, $grill);
//        array_push($options, $related_products_options_end);
//
...
//        $colors_labels = $this->get_admin_color_field($text_options);
...
//            'selected-color' => __('Background color on hover')
//        );
//        foreach ($colors_array as $key => $label_color) {
//            $css = 'background-color:' . $colors_labels[$key];
//            $options_array[] = array($label_color, 'wpc-texts-options', $key, 'text', $colors_labels[$key], 'wpc-color', $css, '', '');
//        }
//        foreach ($options_array as $option_array) {
//            $options_fields[] = $this->get_admin_option_field($option_array[0], $option_array[1], $option_array[2], $option_array[3], $option_array[4], $option_array[5], $option_array[6], $option_array[7], $option_array[8]);
//        }
//        $i = 0;
//        $grill_data = array();
//
//
//        foreach ($options_fields as $fields) {
//            $i = $i + 1;
//            array_push($grill_data, $fields);
//        }
//        $grill = array(
...
//        $colors_labels = $this->get_admin_color_field($shapes_options);
//
//
...
//        foreach ($colors_array as $key => $label_color) {
//            $css = 'background-color:' . $colors_labels[$key];
//            $options_array[] = array($label_color, 'wpc-shapes-options', $key, 'text', $colors_labels[$key], 'wpc-color', $css, '', '');
//        }
//        foreach ($options_array as $option_array) {
//            $options_fields[] = $this->get_admin_option_field($option_array[0], $option_array[1], $option_array[2], $option_array[3], $option_array[4], $option_array[5], $option_array[6], $option_array[7], $option_array[8]);
//        }
...
//        $colors_labels = $this->get_admin_color_field($images_options);
...
//        foreach ($colors_array as $key => $label_color) {
//            $css = 'background-color:' . $colors_labels[$key];
//            $options_array[] = array($label_color, 'wpc-images-options', $key, 'text', $colors_labels[$key], 'wpc-color', $css, '', '');
//        }
//        foreach ($options_array as $option_array) {
//            $options_fields[] = $this->get_admin_option_field($option_array[0], $option_array[1], $option_array[2], $option_array[3], $option_array[4], $option_array[5], $option_array[6], $option_array[7], $option_array[8]);
//        }
...
//        //Design part
//
//        $design_options = $wpc_options_settings['wpc-designs-options'];
//        $colors_labels = $this->get_admin_color_field($design_options);
...
//            'type' => 'image',
//            'title' => __('Tab icon', 'wpd'),
//            'name' => "wpc-designs-options[image]",
//            'set' => 'Set',
//            'remove' => 'Remove'
//        );
...
//        foreach ($colors_array as $key => $label_color) {
//            $css = 'background-color:' . $colors_labels[$key];
//            $options_array[] = array($label_color, 'wpc-designs-options', $key, 'text', $colors_labels[$key], 'wpc-color', $css, '', '');
//        }
//        foreach ($options_array as $option_array) {
//            $options_fields[] = $this->get_admin_option_field($option_array[0], $option_array[1], $option_array[2], $option_array[3], $option_array[4], $option_array[5], $option_array[6], $option_array[7], $option_array[8]);
//        }
...
//        $options = $wpc_options_settings['wpc-general-options'];
    ...
    private function handle_bulk_definition($data) {
        $bounding_box = self::get_proper_value($data, "bounding-box", false);
        $products_parts = self::get_proper_value($data, "products-parts", false);
        $pricing_rules = self::get_proper_value($data, "pricing-rules", false);
        $output_settings = self::get_proper_value($data, "output-settings", false);
        $to_apply = $this->get_bulk_definition_data($data["datasource"], $bounding_box, $products_parts, $pricing_rules, $output_settings);
